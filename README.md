...
- Test: In the "Create Reviewss" link on the left hand side there is a list on all the reviews that were made. If one / more reviews were deemed "inappropriate", tick the box on the side of the review, click the dropdown, click delete and press go!
...
- Menu and Review Pages
The menu and review pages had no errors in it's HTML !
